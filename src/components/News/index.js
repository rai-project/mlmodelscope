      ...
      <React.Fragment>
        <Row type="flex" aligh="middle">
            ...
            <Carousel autoplay>
              {
                this.props.data.images.map(src => {
                  return <img key={yeast()} src={news_images("./"+src)} />
                })
              }
            </Carousel>
          </Col>
          <Col sm={24} md={10} lg={14} offset={2}>
            ...
            <Row>
              <Typography.Title level={3}>{dateToYMD(new Date(this.props.data.date))}</Typography.Title>
            </Row>
            <Row>
        ...
        <Row type="flex" aligh="middle" style={{marginTop: "20px"}}>
          <Col sm={24} md={12} lg={8}>
              <div style={{display: "flex", alignItems: "center", height: "100%", justifyContent: "center"}}>
                <Typography.Title level={3} style={{textAlign: "center"}}>Posters</Typography.Title>
              </div>
          </Col>
          <Col sm={24} md={10} lg={14} offset={2}>
