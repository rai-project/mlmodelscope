...
goog.exportSymbol("proto.carml.org.mxnet.Model.Graph.Attributes", null, global);
  ...
  proto.carml.org.mxnet.Model.Graph.toObject = function(includeInstance, msg) {
    var f,
      obj = {
        ...
        attrs:
          (f = msg.getAttrs()) &&
            proto.carml.org.mxnet.Model.Graph.Attributes.toObject(
              includeInstance,
              f
            )
      };
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 4:
        ...
        break;
      case 5:
        var value = new proto.carml.org.mxnet.Model.Graph.Attributes();
        reader.readMessage(
          value,
          proto.carml.org.mxnet.Model.Graph.Attributes
            .deserializeBinaryFromReader
        );
        msg.setAttrs(value);
        break;
...
proto.carml.org.mxnet.Model.Graph.serializeBinaryToWriter = function(
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.carml.org.mxnet.Model.Graph.Attributes.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.carml.org.mxnet.Model.Graph.Attributes = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.carml.org.mxnet.Model.Graph.Attributes, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.carml.org.mxnet.Model.Graph.Attributes.displayName =
    "proto.carml.org.mxnet.Model.Graph.Attributes";
}
 ...
 * @return {!Object}
 */
  proto.carml.org.mxnet.Model.Graph.Attributes.prototype.toObject = function(
    opt_includeInstance
  ) {
    return proto.carml.org.mxnet.Model.Graph.Attributes.toObject(
      opt_includeInstance,
      this
    );
  };
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.carml.org.mxnet.Model.Graph.Attributes} msg The msg instance to transform.
 * @return {!Object}
 */
  proto.carml.org.mxnet.Model.Graph.Attributes.toObject = function(
    includeInstance,
    msg
  ) {
    var f,
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.carml.org.mxnet.Model.Graph.Attributes}
 */
proto.carml.org.mxnet.Model.Graph.Attributes.deserializeBinary = function(
  bytes
) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.carml.org.mxnet.Model.Graph.Attributes();
  return proto.carml.org.mxnet.Model.Graph.Attributes.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.carml.org.mxnet.Model.Graph.Attributes} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.carml.org.mxnet.Model.Graph.Attributes}
 */
proto.carml.org.mxnet.Model.Graph.Attributes.deserializeBinaryFromReader = function(
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @return {!Uint8Array}
 */
proto.carml.org.mxnet.Model.Graph.Attributes.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.carml.org.mxnet.Model.Graph.Attributes.serializeBinaryToWriter(
    this,
    writer
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.carml.org.mxnet.Model.Graph.Attributes} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.carml.org.mxnet.Model.Graph.Attributes.serializeBinaryToWriter = function(
  message,
  writer
) {
  var f = undefined;
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.carml.org.mxnet.Model.Graph.Attributes.prototype.getAttrsMap = function(
  opt_noLazyCreate
) {
  return /** @type {!jspb.Map<string,string>} */ jspb.Message.getMapField(
    this,
...
proto.carml.org.mxnet.Model.Graph.Attributes.prototype.clearAttrsMap = function() {
...
/**
 * optional Attributes attrs = 5;
 * @return {?proto.carml.org.mxnet.Model.Graph.Attributes}
 */
proto.carml.org.mxnet.Model.Graph.prototype.getAttrs = function() {
  return /** @type{?proto.carml.org.mxnet.Model.Graph.Attributes} */ jspb.Message.getWrapperField(
    this,
    proto.carml.org.mxnet.Model.Graph.Attributes,
    5
  );
...
/** @param {?proto.carml.org.mxnet.Model.Graph.Attributes|undefined} value */
proto.carml.org.mxnet.Model.Graph.prototype.setAttrs = function(value) {
  jspb.Message.setWrapperField(this, 5, value);
};

proto.carml.org.mxnet.Model.Graph.prototype.clearAttrs = function() {
 ...
 * @return {!boolean}
 */
proto.carml.org.mxnet.Model.Graph.prototype.hasAttrs = function() {
